...
impl HarnessRepository {
    ...
    pub(crate) fn from_catalog_json_with_extension_engine(
        artifacts: Arc<dyn ArtifactStore>,
        value: &JsonValue,
        extension_engine: Arc<dyn tea_core::harness::extension::ExtensionEngine>,
        ...
        let mut repository = Self::with_extension_engine(artifacts, extension_engine);
