...
The terminal's /resume picker lists durable session directories for the current
workspace, excluding the session currently attached to the host, and reopens
